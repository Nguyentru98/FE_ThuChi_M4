            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <p class="text-center mb-0">Don't have an Account? <a class="btn btn-primary py-3 w-100 mb-4" onclick="registerForm()">Sign Up</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row h-100 align-items-center justify-content-center" style="min-height: 100vh;">
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <button class="btn btn-primary py-3 w-100 mb-4" onclick="registerUser()">Sign up</button><br>
                            <button class="btn btn-primary py-3 w-100 mb-4" onclick="loadLogin()">Sign in</button>
                        </div>
